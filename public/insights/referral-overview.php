...
<head>
  <meta charset="utf-8">
  <title>Referral Overview | Sideline Sprint</title>
...
<body class="body-font">
    ...
    <div class="container">
      <div class="row pb-1">
        <div class="col-lg-12 text-center pt-1">
          ...
          <h2 class="green-text bold-text pt-15">Referral Overview</h2>
        </div>
      </div>
    </div>
  </div>
  <div class="container">
    <div class="row text-center">
      <div class="col-lg-12">
        ...
        <h3 class="green-text bold-text pb-15">Top Referrers</h3>
  ...
  <script>
    $(document).ready(function() {
      ...
      // Load navigation.
      $("#internal-insights-link, #referral-overview-link").addClass("active");
      $("#internal-insights-link").html('<strong>' + $("#internal-insights-link").text() + '</strong>');
      $("#referral-overview-link").html('<strong class="white-font">' + $("#referral-overview-link").text() + '</strong> <span class="sr-only">(current)</span>');
